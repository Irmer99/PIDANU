      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Test the citizen USSD flow as it appears on a feature phone
          </p>
        </div>
        {!started && (
          <button
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="rounded-lg bg-blue-50 p-4">
            ...
            <p className="text-xs text-blue-600">
              Citizens dial *384*01# on any feature phone. No internet needed — works on
              2G/SMS.
            </p>
          </div>
          <div className="rounded-lg bg-green-50 p-4">
            ...
            <p className="text-xs text-green-600">
              Navigate PDM menus in English, Luganda, Runyankole, or Ateso. Verify NIN,
          ...
          <div className="rounded-lg bg-purple-50 p-4">
            ...
            <p className="text-xs text-purple-600">
              Session data syncs when connected. Citizens can interact offline — changes
